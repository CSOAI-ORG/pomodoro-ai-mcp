<!-- mcp-name: CSOAI-ORG/pomodoro-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/pomodoro-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/pomodoro_ai_mcp/)
...
npx -y @smithery/cli@latest install pomodoro-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/pomodoro-ai-mcp)
